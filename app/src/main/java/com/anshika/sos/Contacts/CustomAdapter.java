...
public class CustomAdapter extends ArrayAdapter<com.raghav.sos.Contacts.ContactModel> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        linearLayout.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                materialAlertDialogBuilder.setTitle("Remove Contact");
                materialAlertDialogBuilder.setMessage("Are you sure want to remove this contact?");
